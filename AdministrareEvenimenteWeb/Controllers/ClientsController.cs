    ...
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Clients != null ? 
                          ...
                          Problem("Entity set 'ProiectContext.Clients'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdClient,Nume,Prenume,Email,Telefon")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdClient,Nume,Prenume,Email,Telefon")] Client client)
        {
